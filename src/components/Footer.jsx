...
const DYMMY_DATA = [
    {
        ...
        email:false,
        title:"Top Products",
        action:['Manage Reputation','Power Tools' , 'Managed Website ', 'Marketing Service',]
    },
    {
        id:2,
        email:false,
        title:"Quick Links",
        action:['Jobs ', 'Brand Assets ', 'Investor Relations' , 'Terms of Service ',]
    },
    {
        id:3,
        email:false,
    ...
    },
    {
        ...
        email:false,
        title:"Resources",
        action:['Guides','Research','Experts','Marketing Service',]
    },
    {
        id:5,
        email:true,
        title:"News letter",
        action:['You can trust us. We nly send promo offers']
    },
  ...
  return (
    <div className='bg-[#0c1a37] py-20'>
        <div className='w-[90%] m-auto flex flex-wrap gap-10 justify-between'>
            {DYMMY_DATA.map(item=>(
            <div key={item.id} className='cursor-pointer text-[white] flex justify-start items-start flex-col gap-5'>
